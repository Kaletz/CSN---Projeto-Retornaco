...
if tipo = 1: #Cooperativa
	...
	cadastro = input("Informe seu CPF ou CNPJ:")
	total_rec = random.uniform(0.4, 16.87)
	...
	print("Através dele, esperamos chegar à marca de mais de 500 toneladas de aço reaproveitado por ano")
